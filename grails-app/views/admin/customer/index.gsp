...
<html>
	...
	<body>
		...
		<div id="list-customer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						<g:sortableColumn property="organisationId" title="${message(code: 'customer.organisationId.label', default: 'Organisation Id')}" />
				...
				<g:each in="${customerInstanceList}" status="i" var="customerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						<td><g:link action="show" id="${customerInstance.id}">${fieldValue(bean: customerInstance, field: "organisationId")}</g:link></td>
